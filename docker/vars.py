VARS = {
    ...
    "riemann": {
        ...
        "config_url": "https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3m4/plugins/riemann-controller/riemann_controller/resources/manager.config",
        "ports": ["5555"],
    ...
    "celery": {
        ...
        "modules": {
                "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.3m4",
                "cloudify_plugins_common": "git+git://github.com/cloudify-cosmo/cloudify-plugins-common.git@3.3m4",
                ...
                "cloudify_agent": "git+git://github.com/cloudify-cosmo/cloudify-agent.git@3.3m4",
                "cloudify_manager": "-b 3.3m4 https://github.com/cloudify-cosmo/cloudify-manager.git",
            },
